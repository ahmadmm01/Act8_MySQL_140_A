...
public class TambahTeman extends AppCompatActivity {
    ...
    private static String url_insert = "https://20200140140.praktikumtiumy.com/tambahtm.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editNama = findViewById(R.id.edNama_tambahteman);
        editTelpon = findViewById(R.id.edTelpon_tambahteman);
        simpanBtn = findViewById(R.id.btnSimpan_tambahteman);
